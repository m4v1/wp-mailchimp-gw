 ...
 */
define('WP_MAILCHIMP_GW_VERSION', '1.0.3');
...
function activate_wp_mailchimp_gw() {
    include_once plugin_dir_path(__FILE__).'includes/class-wp-mailchimp-gw-activator.php';
...
function deactivate_wp_mailchimp_gw() {
    include_once plugin_dir_path(__FILE__).'includes/class-wp-mailchimp-gw-deactivator.php';
